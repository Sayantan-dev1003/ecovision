      ...
      <div className="relative w-full h-auto">
        ...
        <div className="absolute z-20 top-0 left-0 w-full h-full bg-black bg-opacity-30 flex flex-col gap-10 items-center justify-center mobile:hidden tablet:hidden">
          ...
          <div className="flex gap-10">
            <button className="font-bold text-[#434a52] bg-[#FFC107] hover:bg-[#E0A800] hover:text-white outline-none py-2 px-4 rounded-lg" onClick={() => navigate('/signup')}>
              Get Started
            </button>
            <ScrollLink to="about" smooth={true} className="cursor-pointer font-bold text-[#434a52] bg-[#FFC107] hover:bg-[#E0A800] hover:text-white outline-none py-2 px-4 rounded-lg">
              Learn More
            </ScrollLink>
          </div>
        </div>
